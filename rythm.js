;(function(global, factory) {
  ...
  var fontWeight = function(elem, value) {
    var options =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}

    var max = !isNaN(options.max) ? options.max : 900
    var min = !isNaN(options.min) ? options.min : 100
    var fontWeight = (max - min) * value + min
  ...
  var Dancer = (function() {
    function Dancer() {
      ...
      this.registerDance('fontWeight', fontWeight, reset$14)
    }
